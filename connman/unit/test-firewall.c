...
static const char *general_input[] = {
		...
		"-p tcp -m multiport --dports ssh,23:http,9000 -j ACCEPT",
		/* Conntrack */
...
static const char *general_options[] = {
	...
	"-p udp -m helper --helper 23 -j ACCEPT",
	/* limit options */
...
static const char *invalid_general_options[] = {
	...
	"-p tcp -m tcp --sport 23:35 -j ACCEPT",
	...
	"-p tcp -m multiport --dports ssh,http:23,9000 -j ACCEPT",
	"-p tcp -m multiport --dports ssh,http:23:http,9000 -j ACCEPT",
